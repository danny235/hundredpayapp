...
const UserPayList: React.FC<UserPayListProps> = ({ renderSingleItem }) => {
  const avatars: User[] = [
    { id: 'ID: 234GH6', username: 'Ibeneme Ibeneme', avatar: AvatarE },
    { id: 'ID: 235GH6', username: 'Ibeneme Ibeneme', avatar: AvatarE },
    { id: 'ID: 236GH6', username: 'Ibeneme Ibeneme', avatar: AvatarE },
    { id: 'ID: 237GH6', username: 'Ibeneme Ibeneme', avatar: AvatarE },
